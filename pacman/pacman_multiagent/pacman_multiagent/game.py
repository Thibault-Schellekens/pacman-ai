...
class Actions:
    ...
    def getPossibleActions(config, walls):
        ...
        # In between grid points, all game must continue straight
...
class Game:
    """
    The Game manages the control flow, soliciting actions from game.
    """
    ...
    def run(self):
        ...
        # inform learning game of the game start
